...
target_query = target.search('Cytochrome P450')
targets = pd.DataFrame.from_dict(target_query)
targets.to_csv('C:/AIML/targets_data_raw.csv', index=False)

selected_target = targets.target_chembl_id[52]
...
df.to_csv('C:/AIML/bioactivity_data_raw.csv', index=False)

df2 = df[df.standard_value.notna()]
df2 = df2[df.canonical_smiles.notna()]
df2

a = len(df2.canonical_smiles.unique())
print(a)
